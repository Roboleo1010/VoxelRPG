    ...
    class ShaderProgram
    {
        ...
        public void Link()
        {
            ...
            for (int i = 0; i < AttributeCount; i++)
            {
                ...
                GL.GetActiveAttrib(ProgramID, i, 256, out length, out info.size, out info.type, out n);
                name.Append(n);
            ...
            for (int i = 0; i < UniformCount; i++)
            {
                ...
                GL.GetActiveUniform(ProgramID, i, 256, out length, out info.size, out info.type, out n);
                name.Append(n);
